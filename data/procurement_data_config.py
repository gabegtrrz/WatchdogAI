...
METHODS_DATA = {
    ...
    "Limited Source Bidding": {
        "frequency": 0.2,
        "items": {
            "Refracting Telescope 70mm": average_prices.get("Filter Paper pack of 100", 0.0),
            "Triple Beam Balance": average_prices.get("Filter Paper pack of 100", 0.0),
            "pH Meter basic": average_prices.get("Filter Paper pack of 100", 0.0),
            "Graduated Cylinder 100ml": average_prices.get("Filter Paper pack of 100", 0.0),
            "Hot Plate basic": average_prices.get("Filter Paper pack of 100", 0.0),
            "Stopwatch digital": average_prices.get("Filter Paper pack of 100", 0.0),
            "Prism glass": average_prices.get("Filter Paper pack of 100", 0.0),
            "Spring Scale 500g": average_prices.get("Filter Paper pack of 100", 0.0),
            "Bar Magnet pair": average_prices.get("Filter Paper pack of 100", 0.0),
            "Bar Magnet pair": average_prices.get("Filter Paper pack of 100", 0.0),
            "Tuning Fork 256 Hz": average_prices.get("Filter Paper pack of 100", 0.0),
            "Lens Set convex concave": average_prices.get("Filter Paper pack of 100", 0.0),
            "Ammeter basic": average_prices.get("Filter Paper pack of 100", 0.0),
