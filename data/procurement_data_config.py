...
METHODS_DATA = {
    "Competitive Bidding": {
        "frequency": 0.5,
        "items": {
            "Compound Microscope": None,
            "Beaker 50ml": None,
            "Beaker 100ml": None,
            "Beaker 250ml": None, 
            "Test Tube 15ml": None, 
            "Bunsen Burner": None,
            "Thermometer (-10 to 110C)": None, 
            "Microscope Slides": None,
            "Lab Manual - Grade 10 Science": None,
            "Erlenmeyer Flask 250ml": None,
            "Test Tube Rack": None,
            "Filter Paper pack of 100": None,
        }
    },
    "Limited Source Bidding": {
        "frequency": 0.2,
        "items": {
            "Refracting Telescope 70mm": None,
            "Triple Beam Balance": None,
            "pH Meter basic": None,
            "Graduated Cylinder 100ml": None,
            "Hot Plate basic": None,
            "Stopwatch digital": None,
            "Prism glass": None,
            "Spring Scale 500g": None,
            "Bar Magnet pair": None,
            "Tuning Fork 256 Hz": None,
            "Lens Set convex concave": None,
            "Ammeter basic": None,
        }
    },
    "Negotiated Procurement": {
        "frequency": 0.2,
        "items": {
            "Voltmeter basic": None,
            "Hydrochloric Acid": None,
            "Dissecting Kit": None,
            "Petri Dishes pack of 20": None,
            "Universal Indicator Solution 100ml": None,
            "Copper Sulfate": None,
            "Rubber Stoppers": None,
            "Dropper Bottle 50ml": None,
            "Agar Powder 100g": None,
            "Iron Filings 250g": None,
        }
    },
    "Direct Contracting": {
        "frequency": 0.1,
        "items": {
            ...
            "Litmus Paper": None,
            "Pipette 10ml": None,
            "Gloves nitrile box of 100": None,
            "Lab Aprons pack of 10": None,
            "Funnel plastic 100mm": None,
            "Alcohol Burner": None,
            "Fire Blanket": None,
            "Test Tube Brush": None,
            "Microscope Coverslips box of 100": None,
            "Spatula stainless steel": None,
        }
    }
}
